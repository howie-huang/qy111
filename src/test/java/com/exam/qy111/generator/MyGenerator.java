package com.exam.qy111.generator;
...
public class MyGenerator {
    public static void main(String[] args) {
        ...
        sourceConfig.setUrl("jdbc:mysql://localhost:3306/bookdb?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&serverTimezone=CTT&zeroDateTimeBehavior=CONVERT_TO_NULL");
        ...
        packageConfig.setParent("com.exam.qy111");// 自定义包路径
